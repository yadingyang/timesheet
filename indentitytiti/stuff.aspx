...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <asp:Button ID="Logout" class="btn-link loose" runat="server" OnClick="logout" Text="Lougout" /></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div id="welpage" class="container-fluid bg-gr">
            ...
            <h2>
                <asp:Label ID="instruction" runat="server" Text="Please Clockin"></asp:Label>
            </h2>
            <p>&nbsp;</p>
        ...
        <div id="timesheet" class="container-fluid bg-bl">
            ...
            <h1>
                <asp:Label ID="Label1" runat="server" Text="Check My Timesheet"></asp:Label>
            </h1>
